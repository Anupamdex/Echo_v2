...
class Application(tk.Frame):
    def __init__(self, master, screen_width, screen_height):
        ...
        self.welcome_bg_image = self.image_resize(os.path.join(rel_path, "background.png"), adaptive_width, adaptive_height )
        self.main_b1_image = self.image_resize(os.path.join(rel_path, "img0.png"), bt_size, bt_size)
        self.main_b2_image = self.image_resize(os.path.join(rel_path, "img1.png"), bt_size, bt_size)
        self.main_b3_image = self.image_resize(os.path.join(rel_path, "img2.png"), bt_size, bt_size)
        self.main_b4_image = self.image_resize(os.path.join(rel_path, "img3.png"), bt_size, bt_size)
        self.main_b5_image = self.image_resize(os.path.join(rel_path, "img4.png"), bt_size, bt_size)
        self.main_b6_image = self.image_resize(os.path.join(rel_path, "img5.png"), bt_size, bt_size)
        self.exit_b_image = self.image_resize(os.path.join(rel_path, "exit_b0.png"), int(int(adaptive_width)/8), int(int(adaptive_height)/8))

        self.page_bg = self.image_resize(os.path.join(rel_path, "page_bg.png"), adaptive_width, adaptive_height )
        self.content_box = self.image_resize(os.path.join(rel_path, "content_box.png"), int(int(adaptive_width)*(4/5)), int(int(adaptive_height)*(4/5)))


        self.home_c1 = os.path.join(rel_path, "home", "home_c1.png")
        self.home_c2 = os.path.join(rel_path, "home", "home_c2.png")
        self.home_c3 = os.path.join(rel_path, "home", "home_c3.png")

        self.exp_c1 = os.path.join(rel_path, "explore", "exp_c1.png")
        self.exp_c2 = os.path.join(rel_path, "explore", "exp_c2.png")
        self.exp_c3 = os.path.join(rel_path, "explore", "exp_c3.png")

        self.ach_c1 = os.path.join(rel_path, "achieve", "ach_1.png")
        self.ach_c2 = os.path.join(rel_path, "achieve", "ach_2.png")
        self.ach_c3 = os.path.join(rel_path, "achieve", "ach_3.png")
        
        self.more_1 = os.path.join(rel_path, "more", "more_1.png")
        self.more_2 = os.path.join(rel_path, "more", "more_2.png")
        self.more_3 = os.path.join(rel_path, "more", "more_3.png")

        self.map_1 = os.path.join(rel_path, "map", "map_1.png")
        self.map_2 = os.path.join(rel_path, "map", "map_2.png")

        self.con_1 = os.path.join(rel_path, "contact", "con_1.png")
        self.con_2 = os.path.join(rel_path, "contact", "con_2.png")
        self.con_3 = os.path.join(rel_path, "contact", "con_3.png")
        self.con_4 = os.path.join(rel_path, "contact", "con_4.png")
        self.con_5 = os.path.join(rel_path, "contact", "con_5.png")
        ...
        g = open(os.path.join(rel_path, "data.txt"), "r")
        content = g.readlines()
    ...
    def button_call(self, page, text, C1, C2, C3, FL_1, FL_2, FL_3, W, H, x1, x2, x3, y1, y2, y3):
        ...
        def container(footer_label, page_identifier):
            ...
            def show_qr(link, grandparent, parent):  
